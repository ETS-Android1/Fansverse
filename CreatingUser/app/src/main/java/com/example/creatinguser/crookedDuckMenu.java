...
public class crookedDuckMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView viewMenuPic = findViewById(R.id.crookedDuckMenuPic);
        ...
        getImage.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(crookedDuckMenu.this, "Error Loading Image", Toast.LENGTH_SHORT).show();
            }
        });
