...
public class PortCityGallery extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_port_city_gallery);

        String nameOfPic = getIntent().getStringExtra("FirstPic");
        String nameOfPic2 = getIntent().getStringExtra("SecondPic");

        // getting ImageView by its id
        ImageView rImage = findViewById(R.id.portCity1);
        ImageView secondImage = findViewById(R.id.portCity2);
        ...
        getImage.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(PortCityGallery.this, "Error Loading Image", Toast.LENGTH_SHORT).show();
            }
        });
