...
public class MVPGallery extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mvpgallery);

        String nameOfPic = getIntent().getStringExtra("FirstPic");
        String nameOfPic2 = getIntent().getStringExtra("SecondPic");

        // getting ImageView by its id
        ImageView rImage = findViewById(R.id.mvpGrill1);
        ImageView secondImage = findViewById(R.id.mvpGrill2);
        ...
        getImage.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(MVPGallery.this, "Error Loading Image", Toast.LENGTH_SHORT).show();
            }
        });
