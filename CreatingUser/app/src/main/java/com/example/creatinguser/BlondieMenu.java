...
public class BlondieMenu extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_blondie_menu);
        ...
        ImageView viewMenuPic = findViewById(R.id.blondieMenuPic);
        ...
        getImage.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(BlondieMenu.this, "Error Loading Image", Toast.LENGTH_SHORT).show();
            }
        });
